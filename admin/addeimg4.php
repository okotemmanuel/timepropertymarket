...
// prepare and bind
$stmt = $conn->prepare("UPDATE property SET img4=? WHERE id = ?");
...
$stmt->close();
	...
	header("location:property-detail.php?id=$idt");
	exit;
...
<div>		  
<div>photo 4:    <input type="file" name="fileToUpload" id="fileToUpload"><span class="error"><?php echo $photErr;?></span>

 </div>
            	   		          
      <button style="height:60px;"type="submit" class="btn btn-success" name="Submit">Edit Image 4</button>
