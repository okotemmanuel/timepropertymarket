...
<div class="row">
  ...
  <!--img src="images/about.jpg" class="kol img-responsive thumbnail"  alt="realestate"-->
  ...
  software like Aldus PageMaker including versions of Lorem Ipsum.-->
   <button class="btn btn-success"  onclick="window.location.href='aboutb.php'">change business background</button>
  </p>
  <h3>Company Profile</h3>
  <p><?php echo $compf?><!--Contrary to popular belief, Lorem Ipsum is not simply random text. 
  ...
  <button class="btn btn-success"  onclick="window.location.href='aboutp.php'">change Company Profile</button>
  </div>
