...
<div>		  
<div>Cover Image 2:    <input type="file" name="fileToUpload" id="fileToUpload"><span class="error"><?php echo $photErr;?></span>

 </div>
            	   		          
      <button style="height:60px;"type="submit" class="btn btn-success" name="Submit">Add 2 nd Image</button>
